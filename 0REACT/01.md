# # REACT | Day No. 1 | React Basics | Date: 2025-12-26
...
| contenteditable | the content of an element could be editable using this attribute                                                                                                                                                                                                                                                                                                   | `<p contenteditable="true">This is an editable paragraph.</p>`                                   |
| data-\*         | is used to store custom data private to the page or application.                                                                                                                                                                                                                                                                                                   | `<li data-animal-type="bird">Owl</li>`                                                           |
|                 | it is called through using _dataset_ property in javascript                                                                                                                                                                                                                                                                                                        |                                                                                                  |
| dir             | specifies the text direction for the content in an element                                                                                                                                                                                                                                                                                                         | `<p dir="rtl">This text is right to left.</p>`                                                   |
|                 | It has 3 values: "ltr" (left to right), "rtl" (right to left), and "auto" (let the browser decide based on the content)                                                                                                                                                                                                                                            |
| draggable       | specifies whether an element is draggable or not                                                                                                                                                                                                                                                                                                                   | `<div draggable="true">Drag me!</div>`                                                           |
| enterkeyhint    | specifies what action label (or icon) to present for the enter key on virtual keyboards for input fields                                                                                                                                                                                                                                                           | `<input type="text" enterkeyhint="search">`                                                      |
| hidden          | specifies that an element is not yet, or is no longer, relevant                                                                                                                                                                                                                                                                                                    | `<p hidden>This paragraph is hidden.</p>`                                                        |
| inert           | "inert= inert gases" indicates that the element and its subtree are not interactive or perceivable to user agents                                                                                                                                                                                                                                                  | `<div inert>This content is inert.</div>`                                                        |
|                 | it is like disabled but for all elements inside the element with inert attribute                                                                                                                                                                                                                                                                                   |
| inputmode       | specifies what kind of input mechanism would be most helpful for users entering content into an element <br> - It has the follwoing values: <br> (decimal, numeric, tel, email, url, search)                                                                                                                                                                       | `<input type="text" inputmode="numeric">`                                                        |
| lang            | specifies the language of the element's content                                                                                                                                                                                                                                                                                                                    | `<p lang="en">This text is in English.</p>`                                                      |
| popover         | specifies the popover element that is shown when the user interacts with the element <br> - it needs 2 elements. one has popovertarget attribute and the other has popover attribute. we the one with popover attribute is invisible until we invoke the one with the popovertarget, the one with popover needs to have an id that the popovertarget has inside it | `<h1 popover id="myheader">Hello</h1>` <br>`<button popovertarget="myheader">Click me!</button>` |
| spellcheck      | specifies whether the element is to have its spelling and grammar checked or not <br> the following can be spellchecked: <br> - Text values in input elements (not password) <br> - Text in `<textarea>` elements <br> - Text in editable elements                                                                                                                 | `<textarea spellcheck="true">This is a text area.</textarea>`                                    |
| tabindex        | specifies the tab order of an element when the "tab" button is used for navigation                                                                                                                                                                                                                                                                                 | `<button tabindex="1">First Button</button><br><button tabindex="2">Second Button</button>`      |
| title           | specifies extra information about an element (displayed as a tooltip when the mouse hovers over the element) <br> - so when hovering over the element a there will be a tooltip shown on it with the content of the title                                                                                                                                          | `<p title="This is a tooltip">Hover over me!</p>`                                                |
| translate       | specifies whether the content of an element should be translated or not                                                                                                                                                                                                                                                                                            | `<p translate="no">This text will not be translated.</p>`                                        |

|the most important global attributes are:|class, id, style, title, data-\*| the second most important are: tabindex, contenteditable, dir, hidden, lang|

## ! Notes !:

1. How to make browser recognize JSX syntax in javascript files?
...
4. Inline styles in JSX are written as objects with camelCase property names.
   example:
...
const element = <div style={divStyle}>This is a styled div</div>;

//or in simpler way:
const element = <div style={{backgroundColor: 'blue', color: 'white', padding: '10px'}}>This is a styled div</div>;
```

- why is there double curly braces {{ }}?
  - The outer curly braces {} are used to indicate that we are embedding a JavaScript expression inside JSX.
  - The inner curly braces {} are used to define the JavaScript object literal for the style properties and values.
    - So the double curly braces {{ }} are:
      - outer brace: this is a JavaScript expression.
      - inner brace: this is a Javascript object.
